        ...
        {steps.map((s, i) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group relative text-left p-4 lg:p-5 rounded-lg border transition-all",
            ...
            >
              <div className="flex items-center gap-3 mb-1.5">
                <div
                  className={cn(
                    "w-7 h-7 rounded-full flex items-center justify-center text-[11px] font-mono-num font-bold border",
                ...
                <span className={cn("text-[10px] uppercase tracking-[0.2em] font-bold",
                  active ? "text-primary" : "text-muted-foreground")}>
                  Etapa {i + 1}
                </span>
              </div>
              <div className={cn(
                "font-display font-bold text-sm lg:text-base leading-tight",
